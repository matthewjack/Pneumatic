...
#define PN_DELETE(x) { if (x) { delete(x); (x)=NULL; } }      // In C++ you don't need to check for 0, but if is helpful to set deleted pointers to 0.
...
// Hang on - unique according to who? Need to do better than that... Perhaps a function name and line number is more practical.
